create or replace function public.reset_demo_state_for_date(
...
begin
  ...
  -- Explicit predicates preserve the intentionally bounded full-demo reset
  -- while satisfying production's safe-update/delete guard.
  delete from public.bundle_items where true;
  delete from public.audit_events where true;
  delete from public.bundle_sessions where true;
  delete from public.holds where true;
