...
export const metadata: Metadata = {
  description: "Archived source-backed Shibuya planner v2.",
  robots: { follow: false, index: false },
  title: "Legacy Shibuya source planner",
};

export default async function LegacySourcePlannerPage({
  searchParams,
}: {
  ...
  if (normalized.invalid) {
    ...
    redirect(
      target ? `/legacy/source-planner?${target}` : "/legacy/source-planner",
    );
  }
